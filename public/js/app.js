...
module.exports = {
     ...
     */
    mixins: [require('./../mixins/braintree'), require('./../mixins/plans'), require('./../mixins/register')],
    ...
    methods: {
        ...
        getCoupon: function getCoupon() {
            ...
            this.$http.get('/coupon/' + this.query.coupon).then(function (response) {
...
module.exports = {
    ...
    methods: {
        ...
        guessCountry: function guessCountry() {
            ...
            this.$http.get('/geocode/country').then(function (response) {
                if (response.data != 'ZZ') {
...
module.exports = {
    ...
    methods: {
        ...
        drawChart: function drawChart(id, days, dataGatherer, scaleLabelFormatter) {
            ...
            var chart = new Chart(document.getElementById(id).getContext('2d')).Line(data, options);
        },
...
module.exports = {
    ...
    methods: {
        ...
        getAvailableAbilities: function getAvailableAbilities() {
            this.$http.get('/settings/api/token/abilities').then(function (response) {
  ...
  */
   ...
   */
		getInvoices: function getInvoices() {
			...
			this.$http.get(this.urlForInvoices).then(function (response) {
...
module.exports = {
     ...
     * Load mixins for the component.
     */
    mixins: [require('./../../mixins/braintree')],
...
module.exports = {
     ...
     * Load mixins for the component.
     */
    mixins: [require('./../mixins/plans'), require('./../mixins/subscriptions')],
...
module.exports = {
     ...
     * Load mixins for the component.
     */
    mixins: [require('./../../mixins/braintree'), require('./../../mixins/plans'), require('./../../mixins/subscriptions')],
...
module.exports = {
     ...
     * Load mixins for the component.
     */
    mixins: [require('./../../mixins/plans'), require('./../../mixins/subscriptions'), require('./../../mixins/vat')],
...
module.exports = {
    ...
    methods: {
        ...
        getPendingInvitations: function getPendingInvitations() {
            ...
            this.$http.get('/settings/invitations/pending').then(function (response) {
        ...
        reject: function reject(invitation) {
            ...
            this.$http.post('/settings/invitations/' + invitation.id + '/reject').then(function () {
