...
return [
    ...
    MessagingModel::ERROR_WORKSPACE_CREATE_PERMISSION         => "Sorry, you don't have permission to create Workspaces on"
        . " that account.",
    ...
    MessagingModel::ERROR_DELETE_WORKSPACE_PERMISSION         => "Sorry, you don't have permission to delete that"
        . " Workspace.",
    MessagingModel::WARNING_DELETING_WORKSPACE                => "Deleting a workspace will delete all the data related to"
        ." that workspace. This is not reversable. Please confirm.",
